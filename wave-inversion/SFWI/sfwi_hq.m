function [mu_sfwi, mu_helm] = sfwi_hq(U, freqvec, spacing, xyz_order, nohelm, kern_ord)
...
x0 = helm_inv(U, freqvec, spacing);
tol=1e-15;
a=0.01;
b=10;
u_sfwi = HQ_Multiplicative(x0, f, K_sfwi, 'hub', a, b, tol);
