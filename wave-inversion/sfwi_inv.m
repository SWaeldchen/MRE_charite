function [mu_sfwi, mu_helm] = sfwi_inv(U, freqvec, spacing, xyz_order, nohelm, kern_ord)
...
spdiag_ = @(x) spdiags(reshape(cell2mat(x),[],1), 0, N, N);
...
u_sfwi = K_sfwi \ f;
%u_sfwi = lsqr(K_sfwi, f, 1e-15, 10000);
