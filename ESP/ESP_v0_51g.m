function [mag, phi, snr] = ESP_v0_51g(U, freqvec, spacing, denoise_meth, super_factor, unwrap)

% ESP alpha v0.5 (c) 2016 Eric Barnhill. 
% intended for old/young set
% USAGE:
