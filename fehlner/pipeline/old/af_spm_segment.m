function segment_ana2mni(DATA_DIR,TPMdir)
disp(['segment ana2mni']);

if ~exist(fullfile(DATA_DIR,['c1MPRAGE_mprage.nii']),'file');
    ...
    movefile(fullfile(DATA_DIR,['c3MPRAGE.nii']),fullfile(DATA_DIR,['ANA_c2.nii']));   
    movefile(fullfile(DATA_DIR,['c4MPRAGE.nii']),fullfile(DATA_DIR,['ANA_c2.nii']));   
    movefile(fullfile(DATA_DIR,['c5MPRAGE.nii']),fullfile(DATA_DIR,['ANA_c2.nii']));       
