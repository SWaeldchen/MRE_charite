function interpolwrapfield_mod(ANA_DIR,magfile,mod)
...
if (strcmp(magfile,'EPI_MAGf_orig'))
	txtstr = 'orig';
end

if (strcmp(magfile,'EPI_MAGf_dico'))
	txtstr ='dico';
end

if (strcmp(magfile,'EPI_MAGm_orig'))
	txtstr = '1';
end

if (strcmp(magfile,'EPI_MAGm_moco'))
	txtstr = '2';
end

if (strcmp(magfile,'EPI_MAGm_dico'))
	txtstr = '3';
end

if (strcmp(magfile,'EPI_MAGm_modico'))
	txtstr ='4';
end

if ~exist(['wz_Twarp_' txtstr '_' mod '.nii'],'file')
load([magfile '_' mod '_seg8.mat']);
warp_dr_x = Twarp(:,:,:,1);
warp_dr_y = Twarp(:,:,:,2);
warp_dr_z = Twarp(:,:,:,3);
...
hdr_dr_x.fname = ['wx_Twarp_' txtstr '_' mod '.nii'];
hdr_dr_x.private.dat.fname = hdr_dr_x.fname;

hdr_dr_y.fname = ['wy_Twarp_' txtstr '_' mod '.nii'];
hdr_dr_y.private.dat.fname = hdr_dr_y.fname;

hdr_dr_z.fname = ['wz_Twarp_' txtstr '_' mod '.nii'];
