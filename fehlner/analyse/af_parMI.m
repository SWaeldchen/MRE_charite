function af_parMI(PROJ_DIR,Asubject,id,prestr)
...
parfor subj =  1:length(Asubject) %:numel(Asubject)
    ...
    %SUBJ_DIR = ;
    X =  int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,'MNI_MPRAGE_mean.niiAsubject{subj}{1},'ANA','MNI_MPRAGE_mean.niiMNI_MPRAGE.nii'))));
