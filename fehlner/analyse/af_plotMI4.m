function af_plotMI4(PROJ_DIR,id,prestr)
...
%     
    ...
    saveas(gcf,fullfile(PIC_DIR,['MASK_Mutual_' id '_' prestr '_' DATA1str '_' DATA2str '.png']));
    saveas(gcf,fullfile(PIC_DIR,['MASK_Mutual_' id '_' prestr '_' DATA1str '_' DATA2str '.fig']));
    close
end
