function af_parOverlap2(PROJ_DIR,Asubject)
...
%     MASK_orig = (spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','wMAGf_orig_mask.nii'))));
%     MASK_dico = (spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','wMAGf_dico_mask.nii'))));
...
%     SEG_1_mprage(:,:,:,1) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c1_segana_1_MPRAGE.nii'))));
%     SEG_1_mprage(:,:,:,2) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c2_segana_1_MPRAGE.nii'))));
%     SEG_1_mprage(:,:,:,3) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c3_segana_1_MPRAGE.nii'))));
%     SEG_1_mprage(:,:,:,4) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c4_segana_1_MPRAGE.nii'))));
%     SEG_2_mprage(:,:,:,1) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c1_segana_2_MPRAGE.nii'))));
%     SEG_2_mprage(:,:,:,2) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c2_segana_2_MPRAGE.nii'))));
%     SEG_2_mprage(:,:,:,3) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c3_segana_2_MPRAGE.nii'))));
%     SEG_2_mprage(:,:,:,4) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c4_segana_2_MPRAGE.nii'))));
%     SEG_3_mprage(:,:,:,1) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c1_segana_3_MPRAGE.nii'))));
%     SEG_3_mprage(:,:,:,2) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c2_segana_3_MPRAGE.nii'))));
%     SEG_3_mprage(:,:,:,3) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c3_segana_3_MPRAGE.nii'))));
%     SEG_3_mprage(:,:,:,4) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c4_segana_3_MPRAGE.nii'))));
%     SEG_4_mprage(:,:,:,1) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c1_segana_4_MPRAGE.nii'))));
%     SEG_4_mprage(:,:,:,2) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c2_segana_4_MPRAGE.nii'))));
%     SEG_4_mprage(:,:,:,3) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c3_segana_4_MPRAGE.nii'))));
%     SEG_4_mprage(:,:,:,4) = int32(spm_read_vols(spm_vol(fullfile(PROJ_DIR,Asubject{subj}{1},'ANA','EPI_c4_segana_4_MPRAGE.nii'))));
...
for k = 1:31
    B = 10*(k-16); % -150 .. +150 Hz
     ...
     MASK_SEG4 = SEG_3(:,:,:,1)+SEG_4(:,:,:,2)+SEG_4(:,:,:,3) > 0.9;
     ...
     BSEGorig(k,kmask,subj) = corr2(TMP_SEGorig(:),TMP_TPM(:));
     BSEGdico(k,kmask,subj) = corr2(TMP_SEGdico(:),TMP_TPM(:));     
