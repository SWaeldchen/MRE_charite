...
%     rer_MAG1(subj,1)=median(rer_M_orig(BW12));
%     rer_MAG1(subj,2)=median(rer_M_moco(BW12));
%     rer_MAG1(subj,3)=median(rer_M_dico(BW34));
%     rer_MAG1(subj,4)=median(rer_M_modico(BW34));
%     rer_ABSG1(subj,1)=median(rer_A_orig(BW12));
%     rer_ABSG1(subj,2)=median(rer_A_moco(BW12));
%     rer_ABSG1(subj,3)=median(rer_A_dico(BW34));
%     rer_ABSG1(subj,4)=median(rer_A_modico(BW34));
    
%     rer_MAG2(subj,1)=median(rer_M_orig2(BW12));
%     rer_MAG2(subj,2)=median(rer_M_moco2(BW12));
%     rer_MAG2(subj,3)=median(rer_M_dico2(BW34));
%     rer_MAG2(subj,4)=median(rer_M_modico2(BW34));
