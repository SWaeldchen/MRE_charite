function [ sortMatrix isValid ] = autoCreateSortMatrixBasedOnMreImageInfo( complexCube )
...
[ sortFields ] = getMreSortFieldsFromImageInfos( infos );
...
%% helper functions
    ...
    function createSortMatrixFromSortFields()
        sortMatrix=[sortFields.sessIndex;...
            sortFields.freqIndex;...
            sortFields.dirIndex;...
            sortFields.timeStepIndex;...
