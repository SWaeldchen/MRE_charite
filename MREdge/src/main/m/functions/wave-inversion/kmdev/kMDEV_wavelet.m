...
% 
% [c, a, amplitude] = kMDEV_wavelet( MRsignal, inplaneResolution, frequency)
% 
% input:
...
function [c, Lambda, amplitude, shearWaveField, waveField] = kMDEV_wavelet( MRsignal, inplaneResolution, frequency)
