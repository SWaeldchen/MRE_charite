%% function mredge_dicom_to_nii_octave(series_num, data_table, subdir, time_steps)
%
...
% divides into folders by time series. May ontain tweaks for Octave
% functionality
%
% INPUTS:
%
...
function mredge_dicom_to_nii_octave(series_num, data_table, subdir, is_time_series, info)
...
spm_dicom_convert_eb(hdr_table, 'all', 'flat', 'nii');
