...
function y = randsample_eb(v,k,replacement,w)
  ...
  elseif isvector (v)
    ...
    disp ('Octave:invalid-input-arg', 'The input v must be a vector or positive integer.');
  end
   
  if k < 0 || k > n
    disp ('Octave:invalid-input-arg', 'The input k must be an integer between 0 and n.');
  end
