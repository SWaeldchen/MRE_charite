...
function [pks, idx, varargout] = findpeaks_eb (data, varargin)
  ...
  % builtin function).
  if (exist ('inputParser') == 2) %#ok<*EXIST>
    % making use of classdef's inputParser ..
    parser.addParamValue ('MinPeakHeight', 2*std (data_),posscal); %#ok<*NVREPL>
