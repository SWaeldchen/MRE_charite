function y = icplxdual2D_diff(w, J, Fsf, sf)
...
kern = [-0.000008 0.0002 0.0022 -0.034 0.19 -0.79 0 ...
    -0.19 0.034 -0.0022 -0.0002 0.0000008]';
...
for m = 1:2
    for n = 1:2
        lo = w{J+1}{m}{n};
        lo = convn(lo, kern, 'same');
        for j = J:-1:2
            lo = sfb2D_diff(lo, w{j}{m}{n}, sf{m}, sf{n});
        end
        lo = sfb2D_diff(lo, w{1}{m}{n}, Fsf{m}, Fsf{n});
        y = y + lo;
    end
end
