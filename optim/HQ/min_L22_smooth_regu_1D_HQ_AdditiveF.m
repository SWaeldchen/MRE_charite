...
% [x,it,dJ]=min_L22_smooth_regu_1D_HQ_AdditiveF(x0,y,A,phi,a,b,tol,MxIt,c);
function [x,it,dJ]=min_L22_smooth_regu_1D_HQ_AdditiveF(x0,y,A,phi,a,b,tol,MxIt,c);
...
H=A2+b*c*(G'*G);  
% the inverse lelow is less precise than H\w ; Alg is faster
H=inv(H);  
x=x0;       it=0;
dJ = tol^(-10);
