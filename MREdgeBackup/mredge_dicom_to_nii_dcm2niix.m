%% function mredge_dicom_to_nii_dcm2niix(series_num, data_table, subdir, time_steps)
%
...
function mredge_dicom_to_nii_spm(series_num, data_table, subdir, is_time_series, info)
