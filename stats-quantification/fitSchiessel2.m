function [optMu, optAlpha] = fitSchiessel2(storVec, lossVec, freqs, flag)
    eta = 3;
    optMu = 0;
    optAlpha = 0;
    ...
    [mu, alpha, omega] = ndgrid(200:200:4000,  0.1:0.02:0.9, freqs*2*pi);
    [~, ~, Gobs] = ndgrid(200:200:4000,  0.1:0.02:0.9, Gvec);
